...
/* This is why WIN32 must open as "read binary" */
  return ((int) _lseek (f, 0, SEEK_END));
}
...
read_script_file (void)
{
  ...
  ASSERT (_lseek (source, 0, SEEK_SET) >= 0);
  while (!file_end) {
